...
import '../../compnent/my_contribute_card.dart';
...
class MyExchangePage extends StatefulWidget {
  ...
  @override
  State<MyExchangePage> createState() => _MyExchangePageStateState();
}

class _MyExchangePageStateState extends State<MyExchangePage> {
  ...
  getData() async {
    ...
    var result=await DioUtils.instance.getRequest(url: ApiHelper.myexchange,params:map);
